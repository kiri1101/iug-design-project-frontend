import process from 'node:process';globalThis._importMeta_=globalThis._importMeta_||{url:"file:///_entry.js",env:process.env};import { defineComponent, mergeProps, ref, computed, inject, h, Suspense, readonly, provide, shallowReactive, Fragment, useId, hasInjectionContext, getCurrentInstance, nextTick, watch, createElementBlock, shallowRef, cloneVNode, defineAsyncComponent, unref, createApp, renderSlot, createBlock, createCommentVNode, openBlock, Teleport, createElementVNode, toRef, onErrorCaptured, onServerPrefetch, createVNode, resolveDynamicComponent, reactive, effectScope, isReadonly, isRef, isShallow, isReactive, toRaw, getCurrentScope, withCtx, markRaw, useSSRContext, resolveDirective, toDisplayString, normalizeProps, withDirectives, resolveComponent, TransitionGroup, renderList } from 'vue';
import { d as destr, l as klona, m as hasProtocol, n as isScriptProtocol, k as joinURL, w as withQuery, o as parse, q as getRequestHeader, v as isEqual, x as sanitizeStatusCode, y as setCookie, z as getCookie, A as deleteCookie, B as getContext, $ as $fetch$1, C as baseURL, D as createHooks, E as executeAsync, i as createError$1, F as toRouteMatcher, G as createRouter$1, H as defu } from '../_/nitro.mjs';
...
defineComponent({
  ...
  setup(props, { slots, attrs }) {
    const mounted4 = shallowRef(false);
  ...
  createPersistence(
    ...
    (p) => ({
      ...
      serializer: p.serializer ?? {
        serialize: (data3) => JSON.stringify(data3),
        deserialize: (data3) => destr(data3)
      },
...
const useAuthStore = defineStore(
  ...
  () => {
    ...
    const updateAuth = (user) => authUser.value = user;
...
_sfc_main$3.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/Toastr.vue");
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  ...
  const _component_Toastr = _sfc_main$3;
  const _component_NuxtPage = __nuxt_component_0;
  _push(`<!--[-->`);
  _push(ssrRenderComponent(_component_NuxtLoadingIndicator, { color: "#10b981" }, null, _parent));
  _push(ssrRenderComponent(_component_NuxtLayout, null, {
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(ssrRenderComponent(_component_Toastr, null, null, _parent2, _scopeId));
        _push2(ssrRenderComponent(_component_NuxtPage, null, null, _parent2, _scopeId));
      } else {
        return [
          createVNode(_component_Toastr),
