...
import { T as Tooltip } from './index-DzQZa8YE.mjs';
import script$1 from './index-CKSrycVJ.mjs';
import script from './index-DWgx858G.mjs';
import { ref, mergeProps, withCtx, createVNode, unref, createTextVNode, toDisplayString, withModifiers, createBlock, createCommentVNode, openBlock, withDirectives, useSSRContext } from 'vue';
...
import { a as useAuthStore, u as useNuxtApp, n as navigateTo, b as useRuntimeConfig } from './server.mjs';
            ...
            return [
              createVNode("div", { class: "w-52" }, [
                createVNode("ul", { class: "space-y-1" }, [
                  createVNode("li", { class: "p-2 border-b border-gray-300" }, [
