...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      }, _attrs))} data-v-3f6a5b0e><section class="flex-col hidden px-2 text-white md:flex bg-emerald-600" data-v-3f6a5b0e><div class="flex flex-col items-center justify-center space-y-5 grow" data-v-3f6a5b0e><p class="px-4 text-3xl font-semibold text-center lg:text-4xl" data-v-3f6a5b0e> Join us and supercharge the next generation of software </p><img${ssrRenderAttr("src", _imports_0)} class="object-contain object-center size-96" alt="Marum signup illustration" data-v-3f6a5b0e></div><p class="flex justify-between py-1 text-sm" data-v-3f6a5b0e><span data-v-3f6a5b0e>© ${ssrInterpolate(unref(year))} ${ssrInterpolate(unref(config).public.appName)}</span><span data-v-3f6a5b0e>All rights reserved</span></p></section><section class="flex items-center bg-signup-mobile-shape" aria-label="signin form lane" data-v-3f6a5b0e><div class="w-full max-w-md pb-4 mx-auto shadow rounded-xl bg-white/90 md:py-0 md:shadow-none md:bg-inherit shadow-gray-700" data-v-3f6a5b0e><div class="grid items-end justify-center h-20 md:h-36" data-v-3f6a5b0e>`);
      _push(ssrRenderComponent(_component_svg_logo, {
        width: "w-10 md:w-12",
        height: "h-24 md:h-28"
      }, null, _parent));
      _push(`</div><form class="px-3 mt-7 space-y-7" data-v-3f6a5b0e><p class="text-xl font-semibold text-center text-gray-600 md:text-2xl" data-v-3f6a5b0e> Sign In </p><div class="space-y-5" data-v-3f6a5b0e>`);
      _push(ssrRenderComponent(_component_FloatLabel, { variant: "on" }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(`<label for="phone" data-v-3f6a5b0e${_scopeId}> Email address </label>`);
          } else {
            return [
      ...
      _push(ssrRenderComponent(_component_FloatLabel, { variant: "on" }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(`<label for="password" data-v-3f6a5b0e${_scopeId}> Password </label>`);
          } else {
            return [
      ...
      _push(`</div><div class="space-y-5 text-sm text-gray-600" data-v-3f6a5b0e><p class="text-center" data-v-3f6a5b0e> By continuing, you agree to <span class="mr-1.5" data-v-3f6a5b0e>${ssrInterpolate(unref(config).public.appName)}</span>`);
      ...
      _push(`. </p><div class="space-y-3" data-v-3f6a5b0e><p class="text-center" data-v-3f6a5b0e> Do not have an account? `);
      _push(ssrRenderComponent(_component_nuxt_link, {
        to: "/signup",
...
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-3f6a5b0e"]]);

export { index as default };
//# sourceMappingURL=index-CF-w91gT.mjs.map
