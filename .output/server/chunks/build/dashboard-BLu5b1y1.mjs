import { ref, mergeProps, unref, provide, useSSRContext } from 'vue';
import { ssrRenderAttrs, ssrInterpolate, ssrRenderAttr, ssrRenderComponent } from 'vue/server-renderer';
import { use } from 'echarts/core';
import { PieChart, LineChart } from 'echarts/charts';
import { LegendComponent, ToolboxComponent, GridComponent } from 'echarts/components';
...
const __nuxt_component_0 = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-b3250608"]]);
const _sfc_main$1 = {
  __name: "ChartLine",
  __ssrInlineRender: true,
  setup(__props) {
...
const __nuxt_component_1 = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-b8593c0d"]]);
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_chart_line = __nuxt_component_1;
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "space-y-3" }, _attrs))}><div class="flex flex-col gap-3 bg-white rounded-lg"><ul class="flex flex-wrap lg:flex-nowrap gap-3 p-4"><li class="bg-emerald-600 basis-1/4 grow text-white p-3 inline-flex flex-col rounded-md justify-between"><h5 class="text-sm font-semibold">No of Employees</h5><h2 class="text-2xl text-right">${ssrInterpolate(unref(userCount))}</h2></li><li class="bg-emerald-600 basis-1/4 grow text-white p-3 inline-flex flex-col rounded-md justify-between"><h5 class="text-sm md:text-base font-semibold">Budget</h5><div class="flex space-x-1 items-end justify-end"><p class="text-2xl text-right tracking-tighter">74,000,000</p><h5 class="font-semibold">XAF</h5></div></li><li class="bg-emerald-600 basis-1/4 grow text-white p-3 inline-flex flex-col rounded-md justify-between"><div class="flex justify-between items-center"><h5 class="text-sm md:text-base font-semibold">Expenditure</h5><img${ssrRenderAttr("src", _imports_0)} class="size-5 bg-white rounded object-cover object-center mb-2"></div><div class="flex space-x-1 items-end justify-end"><p class="text-2xl text-right tracking-tighter">7,400,000</p><h5 class="font-semibold">XAF</h5></div></li><li class="bg-emerald-600 basis-1/4 grow text-white p-3 inline-flex flex-col rounded-md justify-between"><div class="flex justify-between items-center"><h5 class="text-sm md:text-base font-semibold">Profit margin</h5><img${ssrRenderAttr("src", _imports_1)} class="size-5 bg-white rounded object-cover object-center mb-2"></div><div class="flex space-x-1 items-end justify-end"><p class="text-2xl text-right tracking-tighter">67,600,000</p><h5 class="font-semibold">XAF</h5></div></li></ul><div class="grid sm:grid-cols-2"><div class="grid mx-auto">`);
      _push(ssrRenderComponent(_component_chart_nightingale_pie, null, null, _parent));
      _push(`</div><div class="grid mx-auto">`);
      _push(ssrRenderComponent(_component_chart_nightingale_pie, null, null, _parent));
      _push(`</div></div></div><div class="bg-white rounded-lg"><h5 class="py-2 px-4 text-sm">Classification of leaves</h5><div class="w-[calc(100dvw-14rem)] overflow-auto">`);
      _push(ssrRenderComponent(_component_chart_line, null, null, _parent));
      _push(`</div></div></div>`);
    };
  }
};
...
//# sourceMappingURL=dashboard-BLu5b1y1.mjs.map
