...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      }, _attrs))} data-v-d5cced72><section class="flex-col hidden px-2 text-white md:flex bg-emerald-600" data-v-d5cced72><div class="flex flex-col items-center justify-center space-y-5 grow" data-v-d5cced72><p class="px-4 text-3xl font-semibold text-center lg:text-4xl" data-v-d5cced72> Join us and supercharge the next generation of software </p><img${ssrRenderAttr("src", _imports_0)} class="object-contain object-center size-96" alt="Marum signup illustration" data-v-d5cced72></div><p class="flex justify-between py-1 text-sm" data-v-d5cced72><span data-v-d5cced72>© ${ssrInterpolate(unref(year))} ${ssrInterpolate(unref(config).public.appName)}</span><span data-v-d5cced72>All rights reserved</span></p></section><section class="flex items-center bg-signup-mobile-shape" aria-label="signin form lane" data-v-d5cced72><div class="w-full max-w-md pb-4 mx-auto shadow rounded-xl bg-white/90 md:py-0 md:shadow-none md:bg-inherit shadow-gray-700" data-v-d5cced72><div class="grid items-end justify-center h-20 md:h-36" data-v-d5cced72>`);
      _push(ssrRenderComponent(_component_svg_logo, {
        width: "w-10 md:w-12",
        height: "h-24 md:h-28"
      }, null, _parent));
      _push(`</div><form class="px-3 mt-7 space-y-7" data-v-d5cced72><p class="text-xl font-semibold text-center text-gray-600 md:text-2xl" data-v-d5cced72> Sign In </p><div class="space-y-5" data-v-d5cced72>`);
      _push(ssrRenderComponent(_component_FloatLabel, { variant: "on" }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(`<label for="phone" data-v-d5cced72${_scopeId}> Email address </label>`);
          } else {
            return [
      ...
      _push(ssrRenderComponent(_component_FloatLabel, { variant: "on" }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(`<label for="password" data-v-d5cced72${_scopeId}> Password </label>`);
          } else {
            return [
      ...
      _push(`</div><div class="space-y-5 text-sm text-gray-600" data-v-d5cced72><p class="text-center" data-v-d5cced72> By continuing, you agree to <span class="mr-1.5" data-v-d5cced72>${ssrInterpolate(unref(config).public.appName)}</span>`);
      ...
      _push(`. </p><div class="space-y-3" data-v-d5cced72>`);
...
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-d5cced72"]]);

export { index as default };
//# sourceMappingURL=index-B0UtWDpZ.mjs.map
