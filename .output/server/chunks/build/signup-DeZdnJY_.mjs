...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      }, _attrs))} data-v-a8e2b195><section class="flex-col hidden px-2 text-white md:flex bg-emerald-600" data-v-a8e2b195><div class="flex flex-col items-center justify-center space-y-5 grow" data-v-a8e2b195><p class="px-4 text-3xl font-semibold text-center lg:text-4xl" data-v-a8e2b195> Begin your journey with some great teams </p><img${ssrRenderAttr("src", _imports_0)} class="object-contain object-center size-96" alt="Marum signup illustration" data-v-a8e2b195></div><p class="flex justify-between py-1 text-sm" data-v-a8e2b195><span data-v-a8e2b195>© ${ssrInterpolate(unref(year))} ${ssrInterpolate(unref(config).public.appName)}</span><span data-v-a8e2b195>All rights reserved</span></p></section><section class="flex items-center bg-signup-mobile-shape" aria-label="signin form lane" data-v-a8e2b195><div class="w-full max-w-md pb-4 mx-auto shadow rounded-xl bg-white/90 md:py-0 md:shadow-none md:bg-inherit shadow-gray-700" data-v-a8e2b195><div class="grid items-end justify-center h-20 md:h-36" data-v-a8e2b195>`);
      _push(ssrRenderComponent(_component_svg_logo, {
        width: "w-10 md:w-12",
        height: "h-24 md:h-28"
      }, null, _parent));
      _push(`</div><form class="px-3 mt-7 space-y-7" data-v-a8e2b195><p class="text-xl font-semibold text-center text-gray-600 md:text-2xl" data-v-a8e2b195> Sign In </p><div class="space-y-5" data-v-a8e2b195>`);
      _push(ssrRenderComponent(_component_FloatLabel, { variant: "on" }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(`<label for="firstName" data-v-a8e2b195${_scopeId}> First Name </label>`);
          } else {
            return [
      ...
      _push(ssrRenderComponent(_component_FloatLabel, { variant: "on" }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(`<label for="lastName" data-v-a8e2b195${_scopeId}> Last Name </label>`);
          } else {
            return [
              createVNode(_component_input_text_input, {
                id: "lastName",
      ...
      _push(ssrRenderComponent(_component_FloatLabel, { variant: "on" }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(`<label for="mailingAddress" data-v-a8e2b195${_scopeId}> Email Address </label>`);
          } else {
            return [
              createVNode(_component_input_text_input, {
                id: "mailingAddress",
      ...
      _push(ssrRenderComponent(_component_FloatLabel, { variant: "on" }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(`<label for="phoneNumber" data-v-a8e2b195${_scopeId}> Phone Number </label>`);
          } else {
            return [
      ...
      _push(ssrRenderComponent(_component_FloatLabel, { variant: "on" }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(`<label for="password" data-v-a8e2b195${_scopeId}> Password </label>`);
          } else {
            return [
      ...
      _push(ssrRenderComponent(_component_FloatLabel, { variant: "on" }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(`<label for="password_confirmation" data-v-a8e2b195${_scopeId}> Password Confirmation </label>`);
          } else {
            return [
              createVNode(_component_input_password_input, {
                id: "password_confirmation",
      ...
      _push(`</div><div class="space-y-5 text-sm text-gray-600" data-v-a8e2b195><div class="space-y-3" data-v-a8e2b195><p class="text-center" data-v-a8e2b195> Already have an account? `);
...
const signup = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-a8e2b195"]]);

export { signup as default };
//# sourceMappingURL=signup-DeZdnJY_.mjs.map
